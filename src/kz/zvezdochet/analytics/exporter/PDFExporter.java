			...
			for (String code : codes) {
				...
				if (val >= max) {
					...
					if (code.equals("KARMIC")) {
						...
						text = "Кармические аспекты зашкаливают, значит продвижению вперёд помешает частый возврат к прошлому. Старайтесь вовремя завершать начатое и не оставлять проблемы на потом, чтобы повторно не тратить на них своё драгоценное время";
